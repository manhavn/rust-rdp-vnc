...
def package_linux(target_dir, target_name):
    ...
    pkg_name = f"rust-rdp-vnc_1.0.7_{target_name}"
...
"""
    ...
    # 6. Build .deb
    deb_file = os.path.abspath(os.path.join(target_dir, f"rust-rdp-vnc_1.0.7_{target_name}.deb"))
    ...
    rpm_file = os.path.abspath(os.path.join(target_dir, f"rust-rdp-vnc-1.0.7-1.{target_name}.rpm"))
    ...
    tar_base = os.path.abspath(os.path.join(target_dir, f"rust-rdp-vnc-1.0.7-{target_name}"))
